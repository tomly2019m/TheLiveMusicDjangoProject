class MyUtils {
    ...
    generate_text_shadow(e, l, s) {
        if (s = parseInt(s), e = parseInt(e), 0 === s) return "";
        var _ = [];
        for (let t = -s; t <= s; t += Math.ceil(s / 4)) for (let a = -s; a <= s; a += Math.ceil(s / 4)) _.push(t + "px " + a + "px " + e + "px " + l);
        return _.join(",") + ";";
    }
    change_li_css(a) {
    ...
    push_black(a, t) {
        ...
        null == e[t][l[t][0]] && null == e[t][l[t][1]] ? console.log("无内容") : (a.$data["black_" + t + "_list"].push(e[t]), 
    ...
    create_time_list(a) {
        var t = [], e = document.getElementsByClassName("item"), l = e.length;
    ...
    show_now_lyric(a, t, e, l) {
        if (a < t && parseFloat(e[a][0]) <= l && l <= parseFloat(e[a][1]) + 1) {
            var s;
            for (s of document.getElementsByClassName("item")) s.getElementsByClassName("original")[0].style.cssText = vm.$data.first_style;
    ...
    music_play(s, t) {
        ...
        const o = this.htmlAudioElement.src;
        "lyric" === t && (this.n = 3 * (parseInt(s.$data.v_li_margin) + parseInt(s.$data.li_height)), 
        this.change(s));
        try {
            var a = parseInt(localStorage.getItem(o));
            0 !== (this.htmlAudioElement.currentTime = a) && this.htmlAudioElement.play().then(() => {
        ...
        this.htmlAudioElement.ontimeupdate = () => {
            var a = this.htmlAudioElement.currentTime;
            if (localStorage.setItem(o, a.toString()), "lyric" === t) for (let t = 0; t < _.length; t++) {
                var e, l = _[t];
                if (this.htmlAudioElement.currentTime >= l) {
                    console.log(l), _ = _.slice(t + 1, _.length);
                    for (e of document.getElementsByClassName("item")) e.getElementsByClassName("original")[0].style.cssText = s.$data.first_style;
                    document.getElementById(l).getElementsByClassName("original")[0].style.cssText = s.$data.now_style;
                    for (let a = 0; a <= t; a++) this.change(s);
                }
            }
        }, this.htmlAudioElement.onended = () => {
            localStorage.setItem(o, "0"), this.is_play = 0, s.$data.wss.next_music();
        }, this.update_play_data(s, "replay", 0);
    }
    change(a) {
    ...
    base_control(a, t, e) {
        console.log(e);
        let l, s;
        void 0 !== e.who_play && (a.$data.who_play = e.who_play), void 0 !== e.play_status ? a.$data.play_icon_flag = e.play_status : void 0 !== e.play ? a.$data.play_icon_flag = e.play : a.$data.play_icon_flag = 1, 
        l = void 0 !== e.who_play ? e.who_play === a.$data.who_i_am : a.$data.who_play === a.$data.who_i_am, 
        s = void 0 !== e.replay ? e.replay : 0, console.log("is_play: " + t.is_play);
        e = 0 === a.$data.who_play ? "music" : "lyric";
        a.$data.play_icon_flag && !t.is_play && l ? t.music_play(a, e) : (!a.$data.play_icon_flag && t.is_play && l || a.$data.play_icon_flag && t.is_play && !l) && (t.htmlAudioElement.pause(), 
        t.is_play = 0), s && l && (t.htmlAudioElement.load(), localStorage.setItem(this.htmlAudioElement.src, "1"), 
        t.music_play(a, e));
    }
    music_info_list_control(a, t, e) {
        ...
        let l, s;
        try {
            s = e.music_name_list, l = s[0];
        } catch (a) {
            s = e.music_info_list, l = s[0];
        }
        const _ = [];
        s.forEach(a => {
            _.push(a.file_name);
        }), a.$data.music_info = _, void 0 !== l && void 0 !== l.file_name ? t.is_empty(l.file_name[0]) ? a.$data.wss.next_music() : a.$data.now_music_name = l.file_name.join(", ") : (a.$data.music_info = [ [ "暂无歌曲", "无" ] ], 
    ...
    lyric_control(a, t, e) {
        ...
        t.is_empty(s) ? a.$data.lyric_info = [ {
            id: 0,
            original: "暂无歌词",
    ...
    get_union_data(t, e, a) {
        ...
        a.forEach(a => {
            a = a(t, e);
            l = [ ...l, ...a.callback_list ], s = [ ...s, ...a.which_data_list ];
        }), this.get_data(t, e, s, l);
    }
    is_empty(t) {
        try {
            return "" === t.trim();
    ...
    is_has_field(a, t) {
        let e = !1;
        if ("object" == typeof a) for (const l in a) {
            if (l === t) {
                e = !0;
                break;
            }
    ...
    async test_lyric(a) {
        ...
        var l = [ [ 2, 6 ], [ 6, 8 ], [ 8, 11 ], [ 11, 14 ], [ 14, 15 ], [ 15, 20 ], [ 20, 25 ], [ 25, 30 ], [ 30, 35 ], [ 35, 40 ], [ 40, 45 ], [ 45, 50 ], [ 50, 55 ], [ 55, 60 ], [ 60, 65 ], [ 65, 70 ], [ 70, 75 ], [ 75, 80 ], [ 80, 85 ], [ 85, 90 ], [ 90, 95 ], [ 95, 100 ], [ 100, 105 ], [ 105, 110 ], [ 110, 115 ], [ 115, 120 ], [ 120, 125 ], [ 125, 130 ], [ 130, 135 ], [ 135, 140 ], [ 140, 145 ], [ 145, 150 ] ];
        for (let a = 0; a < 155 && (await this.delayTime(1e3), !this.global_time_break_flag); a++) console.log(a), 
        t = this.show_now_lyric(t, l.length, l, e), e++;
    ...
    change_load_info(a, t, e, l = "") {
        switch (a.$data.load_info_flag = t, e) {
          ...
          case "fail":
            a.$data.load_info_icon = "close", a.$data.load_info = "提交失败 原因: " + l;
            break;
    ...
    get_qq_playlist(l) {
        $.getJSON("get-qq-playlist", {
            url: l.$data.url,
            where_url: l.$data.who_i_am ? "lyric_url" : "music_url"
        }, a => {
            console.log(a);
            var t = a.data.disslist;
            for (let a = 1; a < t.length; a++) {
                var e = t[a];
                console.log("list_name: %s, id: %s", e.diss_name, e.tid), l.$data.playlist_name.push({
                    tid: e.tid,
                    name: e.diss_name,
    ...
    set_idle_playlist(t, a, e) {
        ...
        for (const _ of e.user_playlist.playlist) {
            let a = "";
            var [ l, s ] = _.file_name;
            switch (_.platform) {
              case "qq":
    ...
    update_play_data(a, t, e) {
        e = {
            ...
            data: e,
            where: t,
            where_url: `${a.$data.who_i_am ? "lyric" : "music"}_url`
        };
        $.get("play", e);
    }
    next_music(a) {
    ...
    get_music_info(d) {
        $.getJSON("/get_data", {
            ...
            console.log(a);
            let t, e;
            var l = a.data.music_name_list, s = a.data.who_play, _ = a.data.is_running;
            ...
            if (t.equals([ void 0 ]) && (t = []), s ? $("[name='switch']:eq(0)").prop("checked", !1) : $("[name='switch']:eq(0)").prop("checked", !0), 
            _ ? ($("#start_dan_mu").text("停止统计"), d.$data.start_flag = !0) : ($("#start_dan_mu").text("开始统计"), 
            d.$data.start_flag = !1), l.equals(d.$data.last_list) || (d.$data.last_list = l, 
            d.$data.music_list = l), !t.equals(d.$data.last)) {
    ...
    on_wss(a, t, e) {
        var l, s, _, o, i, d, n, r, c, m, u;
        "LIVE_OPEN_PLATFORM_DM" === a.cmd && (l = e[0], s = e[1], e = e[2], {
            uid: a,
            uname: _,
            guard_level: o,
            fans_medal_name: i,
            fans_medal_level: d,
            fans_medal_wearing_status: n,
            command: r,
            comment: c
        } = t.unpack_dan_mu(a), console.log("comment: " + c + "\ncommand: " + r), 
        "点歌" === r || "." === r ? ({
            music_name: c,
            artist: m,
            status: u
        } = t.dan_mu_msg_filter(l, t, a, _, c, r), l.$data.start_flag && u && l.$data.who_play === l.$data.who_i_am ? t.send_music_info_to_server(l, c, m, s, e) : console.log("stop\n" + c + ": " + m)) : "切歌" !== r && ">" !== r || t.is_black_user(l, a, _) || l.$data.wss.next_music());
    }
    dan_mu_msg_filter(a, t, e, l, s, _) {
        let o, i, d;
        return console.log("comment: " + s + "\ncommand: " + _), o = ("点歌" === _ || "." === _) && (o = !0, 
        void 0 === (s = (s = s.join(" ")).split("&"))[1] && (s = s[0].split("＆")), 
        console.log(s), i = $.trim(s[0]), d = $.trim(s[1]), console.log("music_name: " + i + "\nartist: " + d), 
        o = !t.is_black_user(a, e, l), !t.is_black_music(a, i, d)), {
            music_name: i,
            artist: d,
            status: o
        };
    }
    is_black_music(a, t, e) {
        let l = !1;
        for (const s of a.$data.black_music_list) {
            try {
                t.toUpperCase() === s.music_name.toUpperCase() && (l = !0);
            } catch (a) {}
            try {
                e.toUpperCase() === s.artist.toUpperCase() && (l = !0);
            } catch (a) {}
        }
        return l;
    }
    is_black_user(a, t, e) {
        let l = !1;
        for (const s of a.$data.black_user_list) {
            try {
                t === parseInt(s.uid) && (l = !0);
            } catch (a) {
                console.log("no uid");
            }
            try {
                e.toUpperCase() === s.nick && (l = !0);
            } catch (a) {
    ...
    unpack_dan_mu(a) {
        var t = a.data.uid, e = a.data.msg, l = a.data.uname, s = a.data.guard_level, _ = a.data.fans_medal_name, o = a.data.fans_medal_level, a = a.data.fans_medal_wearing_status, e = e.split("#")[0].split(" ");
        return {
            uid: t,
            uname: l,
            guard_level: s,
            fans_medal_name: _,
            fans_medal_level: o,
            fans_medal_wearing_status: a,
            command: e.shift(),
            comment: e
        };
    }
    send_music_info_to_server(a, t, e, l, s) {
        a.$data.wss.move_music(t, e, -1);
    }
}