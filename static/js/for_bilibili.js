...
function load_for_bili_vue(
    ...
    return new Vue({
        ...
        data: {
            ...
            music_url: '',
            music_info: [{file_name: [user_params.zh, user_params.en]}],
            music_info_test: [
                {file_name: ['Wonder Caravan', '水瀬いのり']},
                {file_name: ['可愛くなりたい', '鎖那']},
                {file_name: ['沈园外', '阿YueYue, 戾格, 小田音乐社']},
                {file_name: ['Wasabi', 'Little Mix']},
                {file_name: ['麻雀学校', '群星']},
                {file_name: ['群青', 'YOASOBI']},
            ],
            now_music_name: '',
            utils: utils,
        },
